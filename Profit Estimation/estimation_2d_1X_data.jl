...
data = readdlm("/Users/amir/github/NPSML-Estimator-Price-Data/Profit Estimation/data02.csv", ',', Float64, '\n', header=true)
...
scatter(data_HHIn1[:,3],data_HHIn1[:,5], markersize=2)
...
for i = 1:size(data_HHI1)[1]
    data_HHI1[i,6] = est_cdf_step_1d(data_HHI1[:,4], data_HHI1[:,1], data_HHI1[i,4], [data_HHI1[i,1]] ,h_HHI1_x)
    data_HHI1[i,7] = est_cdf_step_1d(data_HHI1[:,5], data_HHI1[:,2], data_HHI1[i,5], [data_HHI1[i,2]] , h_HHI1_y1)
end
...
for i = 1:size(data_HHIn1)[1]
    data_HHIn1[i,6] = est_cdf_step_1d(data_HHIn1[:,4], data_HHIn1[:,1], data_HHIn1[i,4], [data_HHIn1[i,1]] ,h_HHI1_x)
    data_HHIn1[i,7] = est_cdf_step_2d(data_HHIn1[:,5], data_HHIn1[:,2], data_HHIn1[:,3], data_HHIn1[i,5], [data_HHIn1[i,2] data_HHIn1[i,3]] , h_HHIn1_y1y2)
end
