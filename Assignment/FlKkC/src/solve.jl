...
"""
function find_best_assignment(cost_matrix::AbstractMatrix{T}) where T
	numRow = zero(T)
	numCol = zero(T)
	...
	u1=zeros(S, numCol) # The dual variable for the columns
    v1=zeros(S, numRow) # The dual variable for the rows.
    ...
    for curUnassCol = 1:numCol
		...
		# println("Run #", numCol,  " Column Dual u: ", u, " Row dual v: ", v )
...
function ShortestPath!(
    ...
    while sink==0
        ...
        @inbounds for curRowScan=1:numRow2Scan
			...
			# println("Row: ", curRow, " Col: ", curCol)
			# println("curRowScan: ", curRowScan, " delta: ", delta,
				# " u[curCol]: ", u[curCol], " v[curRow]: ", v[curRow], " Rcost: ", reducedCost	 )
