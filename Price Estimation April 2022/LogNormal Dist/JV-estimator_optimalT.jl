...
altpar=vcat(tpar[1:8],-2.2417, 3.8117)
altpar2=vcat(tpar[1:8],1.3647, 7.4096)
...
up_data1, down_data1, price_data1, up1, dp1 = sim_data_JV_up_obs(bup1, bdown1, sig_up, sig_down, n_firms, 36, true, up_data[1:2,:],altpar[10])
up_data2, down_data2, price_data2,up2, dp2 = sim_data_JV_up_obs(bup1, bdown1, sig_up, sig_down, n_firms, 36, true, up_data[1:2,:],altpar[10])
...
scatter(up_data[1,:], up_data1[1,:])
scatter(down_data1[1,:], down_data2[1,:])
...
scatter!(up_data2[1,:], down_data2[1,:],
        xlims=(0.5,2), ylims=(0.5,2.5), color =:red,
        markersize = 2 )

scatter(up_data1[2,:], price_data1)
scatter!(up_data2[2,:], price_data2,
        color =:red,
        markersize = 2 )
