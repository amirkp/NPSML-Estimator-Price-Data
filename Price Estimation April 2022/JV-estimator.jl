...
up_data1, down_data1, u_profit1, d_profit1 = sim_data_LP(bup, bdown, sig_up, sig_down, n_firms,20)


# @benchmark find_best_assignment(rand(500,500))


@benchmark sim_data_JV(bup, bdown, sig_up, sig_down, n_firms,20)





@benchmark sim_data_LP(bup, bdown, sig_up, sig_down, n_firms,20)


scatter(up_data[2,:], price)
